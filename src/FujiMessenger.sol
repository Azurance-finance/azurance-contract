...
contract FUJIMessenger is CCIPReceiver, OwnerIsCreator {
    ...
    uint64 public fuji_destinationChainSelector;
    ...
    function _ccipReceive(
        ...
        if (
            ...
            keccak256(abi.encodePacked("lending_is_fine"))
        ) {
            isLendingDemo = false;
        } else if (
            keccak256(abi.encodePacked(lastReceivedText)) ==
            keccak256(abi.encodePacked("lending_is_locked"))
        ) {
            isLendingDemo = true;
        }
    }
